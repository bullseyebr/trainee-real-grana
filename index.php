        ...
        <section>
            <div class="row text-center">
                ...
                <div class="card col-lg-4 col-md-6 col-12 m-2 shadow-lg" style="width: 18rem;">
                    <img class="card-img-top" src="https://picsum.photos/700/300?v=14" alt="Card image cap">
                    <div class="card-body">
                ...
                <div class="card col-lg-4 col-md-6 col-12 m-2 shadow-lg" style="width: 18rem;">
                    <img class="card-img-top" src="https://picsum.photos/700/300?v=18" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk
                            of
                ...
                <div class="card col-lg-4 col-md-6 col-12 m-2 shadow-lg" style="width: 18rem;">
                    <img class="card-img-top" src="https://picsum.photos/700/300?v=71" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk
                            of
